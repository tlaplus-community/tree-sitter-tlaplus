...
(bound_nonfix_op name: (_) @function.builtin)
...
(bound_prefix_op symbol: (_) @operator (#is? @operator function))
...
(bound_infix_op symbol: (_) @operator (#is? @operator function))
...
(bound_postfix_op symbol: (_) @operator (#is? @operator function))
...
(bound_nonfix_op name: (_) @operator (#is? @operator function))
